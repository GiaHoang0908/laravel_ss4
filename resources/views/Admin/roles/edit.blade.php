                ...
                <div class="container">
                    ...
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form ng-app="role" ng-controller="roleController"
                                action=" {{ route('admin.role.update', ['role' => $model->id]) }} " method="POST"
                                role="form">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label class="form-label ">Name role:</label>
                                    <input value="{{ $model->name }}" placeholder="role name..." type="text"
                                        class="form-control col-sm-6" autocomplete="off" name="name">
                                </div>
                                <div class="mb-3">

                                    <label class="form-label">Routes:</label>
                                    <div class="mb-3">
                                        <input ng-model="srole" placeholder="search roles..." type="text" autocomplete="off"
                                    ...
                                    <div style="height: 260px; border: 1px solid #e5e5e5" class="overflow-auto px-4">
                                        <div class="form-check " ng-repeat="r in roles | filter:srole">
                                            <input ng-checked="set_checked(r)" name="route[]" value="@{{ r }}"
