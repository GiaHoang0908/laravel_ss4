        ...
        <div class="page-title">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-left">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Dánh mục đã xóa</li>
                </ol>
            </nav>
        </div>
        <section class="section">
            <div class="card">
                <div class=" card-header bg-white">
                    <u style="color: #0dcaf0; cursor: pointer;" class="font-italic"> Bảng danh sách danh mục đã
                        xóa</u>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($cat as $c)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-trash"
                                            href="{{ route('admin.category.untrash', ['id' => $c->id]) }}"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            btnDelete.onclick = function() {
                formDelete.action = '/admin/category/' + getId;
                formDelete.submit();
            }
