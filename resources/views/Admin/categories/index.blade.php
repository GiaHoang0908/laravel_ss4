        ...
        <div class="page-title">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-left">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Dánh sách danh mục</li>
                </ol>
            </nav>
        </div>
        <section class="section">
            <div class="card">
                <div class=" card-header bg-white">
                    <u style="color: #0dcaf0; cursor: pointer;" class="font-italic"> Bảng danh sách danh mục</u>
                </div>
                <div class="mb-3 bg-white">
                    <a href="{{ route('admin.category.create') }}">
                        <button type="button" class="ml-4 btn btn-success"><i class="mr-2  fas fa-plus"></i>Thêm danh mục
                        </button>
                    </a>
                    ...
                    @if (Session::has('error-category_delete'))
                        <div style="margin: 0 15px;" class="alert alert-danger" role="alert">
                            {{ Session()->get('error-category_delete') }}
                        </div>
                    @endif
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($cat as $c)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-trash"
                                            href="{{ route('admin.category.edit', ['category' => $c->id]) }}"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            btnDelete.onclick = function() {
                formDelete.action = '/admin/category/softDelete/' + getId;
                formDelete.submit();
            }
