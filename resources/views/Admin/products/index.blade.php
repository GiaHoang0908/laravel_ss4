            ...
            <div class="card">
                ...
                <div class="mb-3 bg-white">
                    <a href="{{ route('admin.product.create') }}">
                        <button type="button" class="ml-4 btn btn-success"><i class="mr-2  fas fa-plus"></i>Thêm sản phẩm
                        </button>
                    </a>
                    ...
                    @if (Session::has('error-product_delete'))
                        <div style="margin: 0 15px;" class="alert alert-danger" role="alert">
                            {{ Session()->get('error-product_delete') }}
                        </div>
                    @endif
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($product as $p)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-trash"
                                            href="{{ route('admin.product.edit', ['product' => $p->id]) }}"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            btnDelete.onclick = function() {
                formDelete.action = '/admin/product/softDelete/' + getId;
                formDelete.submit();
            }
