...
@section('title', 'tin tức sản phẩm')
        ...
        <div class="page-title">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-left">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Dánh sách tin tức</li>
                </ol>
            </nav>
        </div>
        <section class="section">
            <div class="card">
                <div class=" card-header bg-white">
                    <u style="color: #0dcaf0; cursor: pointer;" class="font-italic"> Bảng danh sách tin tức</u>
                </div>
                <div class="mb-3 bg-white">
                    <a href="{{ route('admin.news.create') }}">
                        <button type="button" class="ml-4 btn btn-success"><i class="mr-2  fas fa-plus"></i>Thêm tin tức
                        </button>
                    </a>
                        ...
                        <tbody>
                            ...
                            @foreach ($model as $c)
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>{{ $c->title }}</td>
                                    <td><img style="height: 150px" src="{{asset('upload/image/news').'/'.$c->image }}" alt="tin-tuc"></td>
                                    
                                    <td>
                                        <a class="btn-trash"
                                            href="{{ route('admin.news.edit', ['news' => $c->id]) }}"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            btnDelete.onclick = function() {
                formDelete.action = '/admin/news/' + getId;
                formDelete.submit();
            }
