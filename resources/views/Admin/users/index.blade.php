        ...
        <div class="page-title">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-left">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Dánh sách người dùng</li>
                </ol>
            </nav>
        </div>
        <section class="section">
            <div class="card">
                <div class=" card-header bg-white">
                    <u style="color: #0dcaf0; cursor: pointer;" class="font-italic"> Bảng danh sách người dùng</u>
                </div>
                <div class="mb-3 bg-white">
                    <a href="{{ route('admin.role.create') }}">
                        <button disabled type="button" class="ml-4 btn btn-success"><i class="mr-2  fas fa-plus"></i>Thêm
                            người dùng
                        </button>
                    </a>
                </div>
                    ...
                    <table class='table table-bordered ' id="table1">
                        <thead>
                            <tr>
                                ...
                                <th class="text-right" style="border-left: none; border-right: none; color: #fff !important; width: 10px;">
                                    action</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $model)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-trash"
                                            href="{{ route('admin.user.show', ['user' => $model->id]) }}"><i
                                                class="btn btn-warning fas fa-user-cog"></i></a>
                                        <div class="card mt-2 message" style="position:absolute; width: 8rem;">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Xem quyền</li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td>
    ...
    <script>
        $(document).ready(function() {
            ...
            btnDelete.onclick = function() {
                formDelete.action = '/admin/user/' + getId;
                formDelete.submit();
            }
