                    ...
                    <div class="wrapper row  " style="flex-direction:row-reverse;">
                        ...
                        <div class="col l-10 m-12 c-12 ">
                            <div class="home-filter hide-on-mobile-tablet ">
                                ...
                                @if (Request::get('name'))
                                    <a href="{{ route('all', ['name' => request('name'), 'orderBy' => 'ordering']) }}"
                                        ...
                                        <ul class="select-input__list ">
                                            @if (Request::get('orderBy') == 'price_asc')
                                                ...
                                                <li id="get_DESC" class="select-input__item ">
                                                    <a href="{{ route('all', ['name' => request('name'), 'orderBy' => 'price_desc']) }}"
                                                        class="select-input__link ">Giá: Cao đến thấp</a>
                                                </li>
                                            @elseif(Request::get('orderBy') == 'price_desc')
                                                <li id="get_ASC" class="select-input__item ">
                                                    <a href="{{ route('all', ['name' => request('name'), 'orderBy' => 'price_asc']) }}"
                                            ...
                                            @else
                                                ...
                                                <li id="get_DESC" class="select-input__item ">
                                                    <a href="{{ route('all', ['name' => request('name'), 'orderBy' => 'price_desc']) }}" class="select-input__link ">Giá: Cao đến thấp</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                                    ...
                                    <div class="select-input ">
                                        ...
                                        <ul class="select-input__list ">
                                            @if (Request::get('orderBy') == 'price_asc')
                                                ...
                                                <li id="get_DESC" class="select-input__item ">
                                                    <a href="{{ route('all', ['orderBy' => 'price_desc']) }}"
                                                        class="select-input__link ">Giá: Cao đến thấp</a>
                                                </li>
                                            @elseif(Request::get('orderBy') == 'price_desc')
                                                <li id="get_ASC" class="select-input__item ">
                                                    <a href="{{ route('all', ['orderBy' => 'price_asc']) }}"
                                                        class="select-input__link ">Giá: Thấp đến cao</a>
                                                </li>
                                                <li id="get_DESC" class="select-input__item ">
                                                    <a class="select-input__link ">Giá: Cao đến thấp</a>
                            ...
                            @if (Request::get('name'))
                                @if (count($all) > 0)
                                    <div class="mt-4 alert alert-success" role="alert">
                                        {{ count($all) }} kết quả tìm kiếm cho từ khoá '{{ Request::get('name') }}'
                                    </div>
                                @else
