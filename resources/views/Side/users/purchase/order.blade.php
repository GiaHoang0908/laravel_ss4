            ...
            <div class="tab-content">
                <div class="tab-pane  active" id="1a">
                    <div class="container-fluid mb-4 ttdh">
                        <nav class="navbar ">
                            <div class="container-fluid d-flex">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class=" navbar-brand">ID ĐƠN HÀNG. {{ $ctdh->id }}</div>
                                    ...
                                    @else
                                        <div class="d-flex">
                                            <div class="status text-uppercase ">{{ $ctdh->status }}</div>
                                        </div>
                                    @endif
                                </div>
                        ...
                        <hr>
                        @if (($ctdh->status == 'Chưa xử lý' || $ctdh->status == 'Chờ lấy hàng') && !$ctdh->deleted_at)
                            <form method="POST" action="{{ route('updateInfo', ['id'=> $ctdh->id]) }}" class="card-body container">
                                @csrf
                                <h3 class="mb-4">Địa chỉ nhận hàng</h3>
                                <div class="pt-3">
                                    <input name="name" class="form-control col-sm-4 col-form-label" type="text"
                                        value="{{ $ctdh->name }}">
                                </div>
                                @error('name')
                                ...
                                @enderror
                                <div class="pt-3">
                                    <input name="phone_number" class="form-control col-sm-4 col-form-label" type="text"
                                        value="{{ $ctdh->phone_number }}">
                                </div>
                                @error('phone_number')
                                    <div class="alert alert-danger col-sm-4" role="alert">
                                        {{ $message }}
                                ...
                                @enderror
                                <div class="pt-3">
                                    <textarea name="address" class="form-control col-sm-4 col-form-label" name="" id=""
                                        cols="30" rows="10">{{ $ctdh->address }}</textarea>
                                ...
                                @enderror
                                <button type="submit" style="width: 80px; border: 1px solid #5a8dee"
                                    class="mt-4 btn btn-outline-primary">Sửa</button>
                            </form>
                        @else
                            <div class="card-body">
                                <h3 class="mb-4">Địa chỉ nhận hàng</h3>
                                <div class="row pt-3">
                                    <label class="col-sm-4 col-form-label">{{ $ctdh->name }}</label>

                                </div>
                                <div class=" row">
                                    <label id="phone_number" for="inputPassword" class="col-sm-4 col-form-label">(+84)
                                        {{ $ctdh->phone_number }}</label>
                                </div>
                                <div class=" row">
                        ...
                        <div class="tab-pane-title">
                            <div class=" checkout-form">
                                <div class="form-product">
                                    @foreach ($ctdh->detailSalesInvoice as $j)
                                    ...
                                    <table class="table" style="text-align: right; width: 98%; margin: auto;">
                                        ...
                                        <tbody class="">
                                            <tr class="row">
                                                ...
                                                <td class="col-sm-3">
                                                    ₫{{ number_format($ctdh->total_price, 0, ',', '.') }}</td>
                                            ...
                                            <tr class="row">
                                                ...
                                                <td class="col-sm-3">
                                                    ...
                                                    <div style="font-size: 30px; line-height: 100%" class="cart-value">
                                                        ₫{{ number_format($ctdh->total_price, 0, ',', '.') }}</div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div style="display: flex; align-items: center" class="cart-info">
                                    <img style="height:28px" class="mr-3"
                                        ...
                                        alt="">
                                    <div style="font-size: 12px; color: #999" class="cart-title">Phương thức thanh toán:
                                    </div>
...
@section('script')
    ...
    <script>
        ...
        if(phone)
        {
            phone.textContent = phone.textContent.substr(0, 6) + phone.textContent.substr(-9)
        }
